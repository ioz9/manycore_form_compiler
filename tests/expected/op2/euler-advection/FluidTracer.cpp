...
{
  op_par_loop(Mass, "Mass", elements, op_arg_mat(Tracer_mat, OP_ALL, Tracer_map, OP_ALL, Tracer_map, OP_INC), op_arg_dat(Coordinate_data, OP_ALL, Coordinate_map, OP_READ));
  op_par_loop(rhs, "rhs", elements, op_arg_dat(Tracer_vec, OP_ALL, Tracer_map, OP_INC), op_arg_dat(Coordinate_data, OP_ALL, Coordinate_map, OP_READ), op_arg_dat(Tracer_data, OP_ALL, Tracer_map, OP_READ), op_arg_dat(Velocity_data, OP_ALL, Velocity_map, OP_READ));
